...
<div x-data="{ open: false }" class="relative flex-1 md:flex-none sm:w-auto shrink-0 text-sm sm:text-base" @click.outside="open = false">
    <div @click="open = !open"
        class="flex items-center justify-between gap-3 h-10 py-2 px-3.5 sm:px-7 border rounded-2xl hover:border-blue-500 transition cursor-pointer md:w-45 whitespace-nowrap
